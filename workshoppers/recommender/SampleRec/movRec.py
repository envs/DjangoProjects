...
# data = pd.read_csv('/Users/dinance/Downloads/EE/OpenVINO/ml-25m/ratings.csv') # Larger Dataset
...
# Average rating for each and every movie
...
# Toy Story (1995), & with at least 100 ratings
